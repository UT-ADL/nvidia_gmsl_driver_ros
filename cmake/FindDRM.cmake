...
# * Try to find DRM Once done this will define DRM_FOUND - System has DRM

find_package(PkgConfig)
pkg_check_modules(PC_DRM QUIET libdrm)

find_path(DRM_INCLUDE_DIR /drm.h /usr/include/libdrm /usr/include/drm)

find_library(DRM_LIBRARY drm PATHS /usr/lib)
...
if(DRM_LIBRARY)
  ...
  set_target_properties(
    drm
    PROPERTIES IMPORTED_LOCATION ${DRM_LIBRARY}
  ...
  set_target_properties(drm PROPERTIES IMPORTED_LOCATION_RELEASE ${DRM_LIBRARY})
