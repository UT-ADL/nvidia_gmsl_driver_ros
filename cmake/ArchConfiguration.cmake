...
elseif(CMAKE_SYSTEM_NAME MATCHES "Linux")
  ...
  elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "armv7l" OR CMAKE_SYSTEM_PROCESSOR
                                                     STREQUAL "aarch64")
    message(
      FATAL_ERROR
        "Direct compilation not supported for ${CMAKE_SYSTEM_PROCESSOR}, use cross compilation."
    )
  else()
    message(
      WARNING "Unable to detect CPU architecture : '${CMAKE_SYSTEM_PROCESSOR}'."
    )
  endif()
else()
...
set(SDK_CPP_ARCH_DIR
    ${CPP_ARCH_DIR}
    CACHE INTERNAL "")

# Dependencies that are C only and don't care about abi are stored under
# SDK_C_ARCH_DIR
