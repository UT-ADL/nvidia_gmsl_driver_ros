...
bool shouldUseColor(bool streamIsTTY)
{
  ...
  const bool termOk = (term == "xterm") || (term == "xterm-color") || (term == "xterm-256color") ||
                      (term == "screen") || (term == "screen-256color") || (term == "tmux") ||
                      (term == "tmux-256color") || (term == "rxvt-unicode") || (term == "rxvt-unicode-256color") ||
...
void printColored(FILE* fd, EConsoleColor color, const char* msg)
{
  ...
  fflush(fd);
  SetConsoleTextAttribute(fdHandle, getColorAttribute(color) | FOREGROUND_INTENSITY);
  fprintf(fd, msg);
